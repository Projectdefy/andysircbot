...
def switch_cam1():
    ...
    SendInput(Keyboard(VK_CONTROL), Keyboard(VK_SHIFT), Keyboard(VK_F3))
    time.sleep(0.2)
    SendInput(Keyboard(VK_CONTROL, KEYEVENTF_KEYUP),
              Keyboard(VK_SHIFT, KEYEVENTF_KEYUP),
              Keyboard(VK_F3,  KEYEVENTF_KEYUP))
    time.sleep(0.2)

# Sends the keyboard input CTRL + Shift + F4
def switch_cam2():
    send_message(CHAN, 'SWITCHING TO FACECAM SCENE')
    SendInput(Keyboard(VK_CONTROL), Keyboard(VK_SHIFT), Keyboard(VK_F4))
    time.sleep(0.2)
    SendInput(Keyboard(VK_CONTROL, KEYEVENTF_KEYUP),
              Keyboard(VK_SHIFT, KEYEVENTF_KEYUP),
              Keyboard(VK_F4,  KEYEVENTF_KEYUP))
    time.sleep(0.2)

# Sends the keyboard input CTRL + Shift + F5
def switch_cam3():
    send_message(CHAN, 'SWITCHING TO BRB SCENE')
    SendInput(Keyboard(VK_CONTROL), Keyboard(VK_SHIFT), Keyboard(VK_F5))
    time.sleep(0.2)
    SendInput(Keyboard(VK_CONTROL, KEYEVENTF_KEYUP),
              Keyboard(VK_SHIFT, KEYEVENTF_KEYUP),
              Keyboard(VK_F5, KEYEVENTF_KEYUP))
    time.sleep(0.2)

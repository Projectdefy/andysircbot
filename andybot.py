...
def switch_cam1():
    ...
    SendInput(Keyboard(VK_CONTROL), Keyboard(VK_SHIFT), Keyboard(KEY_5))
    time.sleep(0.2)
    SendInput(Keyboard(VK_CONTROL, KEYEVENTF_KEYUP),
                  Keyboard(VK_SHIFT, KEYEVENTF_KEYUP),
                  Keyboard(KEY_5,  KEYEVENTF_KEYUP))
    time.sleep(0.2)

# Sends the keyboard input CTRL + Shift + 7
def switch_cam2():
    send_message(CHAN, 'SWITCHING TO FACECAM SCENE')
    SendInput(Keyboard(VK_CONTROL), Keyboard(VK_SHIFT), Keyboard(KEY_7))
    time.sleep(0.2)
    SendInput(Keyboard(VK_CONTROL, KEYEVENTF_KEYUP),
                  Keyboard(VK_SHIFT, KEYEVENTF_KEYUP),
                  Keyboard(KEY_7,  KEYEVENTF_KEYUP))
    time.sleep(0.2)

# Sends the keyboard input CTRL + Shift + 3
def switch_cam3():
    send_message(CHAN, 'SWITCHING TO BRB SCENE')
    SendInput(Keyboard(VK_CONTROL), Keyboard(VK_SHIFT), Keyboard(KEY_3))
    time.sleep(0.2)
    SendInput(Keyboard(VK_CONTROL, KEYEVENTF_KEYUP),
                  Keyboard(VK_SHIFT, KEYEVENTF_KEYUP),
                  Keyboard(KEY_3,  KEYEVENTF_KEYUP))
    time.sleep(0.2)

# Sends the keyboard input CTRL + Shift + 6
def switch_cam4():
    send_message(CHAN, 'SWITCHING TO ELGATO SCENE')
    SendInput(Keyboard(VK_CONTROL), Keyboard(VK_SHIFT), Keyboard(KEY_6))
    time.sleep(0.2)
    SendInput(Keyboard(VK_CONTROL, KEYEVENTF_KEYUP),
                  Keyboard(VK_SHIFT, KEYEVENTF_KEYUP),
                  Keyboard(KEY_6, KEYEVENTF_KEYUP))
    time.sleep(0.2)

# --------------------------------------------- End Command Functions ----------------------------------------------

# ------------------------------------ Start of Virtual Keyboard Settings ------------------------------------------
# virtualkeyboard.py
# Virtual Keyboard and Mouse to simulate keypresses
...
# ------------------------------------ End of Virtual Keyboard Settings --------------------------------------------
